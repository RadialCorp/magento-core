...
class Radial_Amqp_Test_Model_RunnerTest extends Radial_Core_Test_Base
{
    /** @var Radial_Core_Helper_Data mock*/
    protected $_coreHelper;
    /** @var Radial_Amqp_Helper_Data mock */
    protected $_helper;
    /** @var Radial_Amqp_Helper_Config mock */
    ...
    {
        $this->_coreHelper = $this->getHelperMock('radial_core/data');
        $this->_helper = $this->getHelperMock('radial_amqp');
    ...
    public function testDispatchPayloadEvents()
    {
        ...
        $runner = Mage::getModel('radial_amqp/runner');
