...
class Radial_Amqp_Test_Helper_ConfigTest extends Radial_Core_Test_Base
{
    /** @var Mage_Core_Model_App original Mage::app instance */
    protected $_origApp;
    /** @var ITestMessage */
    protected $_payload;
    /** @var Radial_Amqp_Model_Config */
    ...
    public function setUp()
    {
        ...
        $this->_configMap = $this->getModelMock('radial_amqp/config');
    }
    /**
     ...
     *                 - 'amqp_config' => Radial_Core_Model_Config_Registry for Radial_Amqp config
     *                 - 'core_config' => Radial_Core_Model_Config_Registry for Radial_Core config
     */
    ...
    {
        // array of stores and configuration for amqp and radial_core, each inner array
        ...
        $coreHelper = $this->getHelperMock('radial_core', array('getConfigModel'));
        ...
        $configHelper = Mage::helper('radial_amqp/config');
    ...
    public function testUpdateLastTimestamp()
    {
        ...
        $helper = $this->getHelperMock('radial_amqp/config', array('getScopeForStoreSettings'));
