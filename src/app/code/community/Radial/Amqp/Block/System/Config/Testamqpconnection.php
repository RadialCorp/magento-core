 ...
 */
class Radial_Amqp_Block_System_Config_Testamqpconnection extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    const VALIDATION_URL = '*/exchange_system_config_validate/validateamqp';
    /** @var string */
    protected $_template = 'radial_amqp/system/config/testamqpconnection.phtml';
    ...
    protected function _construct()
    {
        list($this->_amqpHelper) = $this->_checkTypes(
            $this->getAmqpHelper() ?: Mage::helper('radial_amqp')
        );
    }
    /**
     * Type hints for injected dependencies via the self::__construct $args
     * @param  Radial_Amqp_Helper_Data $amqpHelper
     * @return mixed[]
     */
    protected function _checkTypes(Radial_Amqp_Helper_Data $amqpHelper)
    {
