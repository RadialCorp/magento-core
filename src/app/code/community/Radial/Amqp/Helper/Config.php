...
class Radial_Amqp_Helper_Config
{
    ...
    {
        $this->_helper = Mage::helper('radial_amqp');
        $this->_coreHelper = Mage::helper('radial_core');
        $this->_mageHelper = Mage::helper('core');
        $this->_amqpConfigMap = Mage::getSingleton('radial_amqp/config');
        $this->_coreConfigMap = Mage::getSingleton('radial_core/config');
