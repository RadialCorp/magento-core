...
class Radial_Amqp_Model_Runner
{
    ...
    protected function _consumeQueue($queue, Mage_Core_Model_Store $store)
    {
        ...
        $this->_api->getChannel()->basic_consume($this->_helper->_processQueueName($queue, $this->_coreHelper->getConfigModel($store)), '', false, false, false, false, array($this, 'process'));
