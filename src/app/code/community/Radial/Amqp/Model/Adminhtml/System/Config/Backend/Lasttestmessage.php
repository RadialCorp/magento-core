...
class Radial_Amqp_Model_Adminhtml_System_Config_Backend_Lasttestmessage extends Mage_Core_Model_Config_Data
{
    const NO_TEST_MESSAGE_RECEIVED = 'Radial_Amqp_No_Test_Message_Received';
    ...
    {
        $this->_helper = $this->getData('helper') ?: Mage::helper('radial_amqp');
        $this->_coreHelper = $this->getData('core_helper') ?: Mage::helper('radial_core');
