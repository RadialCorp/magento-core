...
class Radial_Amqp_Model_Api_Validator
{
    const INVALID_CONFIGURATION = 'Radial_Amqp_Api_Validator_Invalid_Configuration';
    const NO_QUEUES_CONFIGURED = 'Radial_Amqp_Api_Validator_No_Queues_Configured';
    const CONNECTION_FAILED = 'Radial_Amqp_Api_Validator_Connection_Failed';
    const CONNECTION_SUCCESS = 'Radial_Amqp_Api_Validator_Connection_Success';
    const UNABLE_TO_VALIDATE = 'Radial_Amqp_Api_Validator_Unable_To_Validate';
     ...
     * @throws Radial_Amqp_Exception_Configuration_Exception
     * @return self
     */
    protected function _validateConfiguration($hostname, $username, $password)
    {
        ...
        if ($invalidSettings) {
            throw Mage::exception(
                'Radial_Amqp_Exception_Configuration',
     ...
     * @param string $username
     * @param string $password
     * @throws Radial_Amqp_Exception_Connection_Exception
     * @return self
     */
    protected function _validateConnection($hostname, $username, $password)
    {
        ...
        if (!$queues) {
            throw Mage::exception('Radial_Amqp_Exception_Configuration', $this->_helper->__(self::NO_QUEUES_CONFIGURED));
        }
        ...
        if (!$amqpApi->isConnected()) {
            throw Mage::exception('Radial_Amqp_Exception_Connection', $this->_helper->__(self::CONNECTION_FAILED));
        }
        return $this;
    }
    /**
