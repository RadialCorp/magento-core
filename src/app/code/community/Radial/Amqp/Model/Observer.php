...
class Radial_Amqp_Model_Observer
{
    /** @var Radial_Amqp_Helper_Config */
    protected $_configHelper;
    /**
     * @param array $initParams May contain:
     *                          - 'config_helper' => Radial_Amqp_Helper_Config
     */
    public function __construct(array $initParams = array())
    {
        list($this->_configHelper) = $this->_checkTypes(
            $this->_nullCoalesce($initParams, 'config_helper', Mage::helper('radial_amqp/config'))
        );
        $this->_configHelper = Mage::helper('radial_amqp/config');
    }
    /**
     * Type checks for self::__construct $initParams
     * @param  Radial_Amqp_Helper_Config $configHelper
     * @return mixed[]
     */
    protected function _checkTypes(Radial_Amqp_Helper_Config $configHelper)
    {
