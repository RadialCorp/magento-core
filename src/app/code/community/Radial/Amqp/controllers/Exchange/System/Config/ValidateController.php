...
class Radial_Amqp_Exchange_System_Config_ValidateController extends Mage_Adminhtml_Controller_Action
{
     ...
     * @param Radial_Amqp_Helper_Api_Validator
     * @return mixed[]
     */
    protected function _checkTypes(
        Radial_Core_Helper_Validator $validatorHelper
    ) {
     ...
     * @return Radial_Amqp_Model_Api_Validator
     */
    protected function _getAmqpApiValidator($store)
    {
        return Mage::getModel('radial_amqp/api_validator', array('store' => $store));
    }
    /**
    ...
    public function validateamqpAction()
    {
        ...
        $configMap = Mage::getModel('radial_amqp/config');
