...
class Radial_Order_Test_Model_Eav_Entity_Increment_OrderTest extends Radial_Core_Test_Base
{
    ...
    // @var Mock_Radial_Core_Helper_Data mock core helper scripted to return config
    public $coreHelper;
    // @var Mock_Radial_Core_Model_Config_Registry config registry expected to be used
    public $coreConfig;
    // @var Mock_Radial_Core_Model_Config_Registry config registry not expected to be used
    public $coreConfigDefault;
    // @var Mock_Mage_Core_Model_App mock app scripted to return expected store information
    public $testApp;
    // @var Radial_Order_Model_Eav_Entity_Increment_Order test object
    ...
    public function setUp()
    {
        ...
        $this->incrementModel = Mage::getModel('radial_order/eav_entity_increment_order');
        ...
        $this->coreHelper = $this->getHelperMock('radial_core/data', ['getConfigModel']);
    ...
    public function testGetNextId($lastId, $nextId)
    {
        $this->testApp->expects($this->any())
            ->method('getStore')
            ->will($this->returnValue($this->targetStore));
        $this->replaceByMock('helper', 'radial_core', $this->coreHelper);
