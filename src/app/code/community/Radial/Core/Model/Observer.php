...
class Radial_Core_Model_Observer
{
    ...
    /**
     * Update the radial_core session with the new quote.
    ...
    /**
     * @return Radial_Core_Model_Session|Mage_Core_Model_Abstract
     */
    protected function getCoreSession()
    {
        if (!$this->session) {
            $this->session = Mage::getSingleton('radial_core/session');
        }
        return $this->session;
    }
