 ...
 */
class Radial_Core_Block_System_Config_Testsftpconnection extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('radial_core/system/config/testsftpconnection.phtml');
        }
        return $this;
    }
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $this->addData(array(
            'button_label' => Mage::helper('radial_core')->__($originalData['button_label']),
