 ...
 */
class Radial_Core_Block_System_Config_Testapiconnection extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('radial_core/system/config/testapiconnection.phtml');
        }
        return $this;
    }
