...
class Radial_Core_Test_Model_System_Config_Backend_Language_CodeTest extends Radial_Core_Test_Base
{
    /*
    ...
    {
        $mockLangHelper = $this->getHelperMock('radial_core/languages', ['validateLanguageCode']);
		 ...
		 * there's been a change so we return true on 'isValueChanged'.
	 	 */
        $backendMock = $this->getModelMockBuilder('radial_core/system_config_backend_language_code')
    ...
    public function testInvalidLanguageCodeException()
    {
        ...
        $mockCoreHelper = $this->getHelperMock('radial_core/data', ['__']);
        ...
        $this->setExpectedException('Radial_Core_Exception');
