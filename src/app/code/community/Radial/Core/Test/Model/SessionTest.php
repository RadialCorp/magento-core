...
class Radial_Core_Test_Model_SessionTest extends Radial_Core_Test_Base
{
    ...
    public function testExtractQuoteSkuData()
    {
        ...
        $helper = $this->getHelperMock('radial_core/quote_item', ['isItemInventoried']);
        $this->replaceByMock('helper', 'radial_core/quote_item', $helper);
        ...
        $session = $this->getModelMockBuilder('radial_core/session')
            ->disableOriginalConstructor()
            ->setMethods(null)
            ->getMock();
        $this->assertSame(
    ...
    {
        $session = $this->getModelMockBuilder('radial_core/session')->disableOriginalConstructor()->setMethods(null)->getMock();
