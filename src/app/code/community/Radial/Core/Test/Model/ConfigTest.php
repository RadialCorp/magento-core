 ...
 * the config model interface required by the Radial_Core_Helper_Config
 */
class Radial_Core_Test_Model_ConfigTest extends EcomDev_PHPUnit_Test_Case
{
    /**
 ...
 * @codeCoverageIgnore
 */
class ConfigStub extends Radial_Core_Model_Config_Abstract
{
