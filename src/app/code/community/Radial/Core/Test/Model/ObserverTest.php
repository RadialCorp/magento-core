...
class Radial_Core_Test_Model_ObserverTest extends Radial_Core_Test_Base
{
    /** @var Radial_Core_Model_Observer */
    protected $observer;

    public function setUp()
    {
        $this->observer = Mage::getModel('radial_core/observer');
    }
    ...
    public function testCheckQuoteForChanges()
    {
        ...
        $this->replaceByMock('model', 'radial_core/session', $session);
