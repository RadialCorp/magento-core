...
abstract class Radial_Core_Test_Base extends EcomDev_PHPUnit_Test_Case
{

    const EB2CCORE_CONFIG_REGISTRY_MODEL = 'radial_core/config_registry';
    ...
    /**
     * Replaces the Magento radial_core/config_registry model.
     *
