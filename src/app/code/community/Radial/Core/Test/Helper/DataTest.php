...
class Radial_Core_Test_Helper_DataTest extends Radial_Core_Test_Base
{
    protected $_helper;
    /**
     * setUp method
    ...
    {
        $this->assertInstanceOf('EbayEnterprise_Dom_Document', Mage::helper('radial_core')->getNewDomDocument());
    }
    ...
    public function testApiUriCreation()
    {
        ...
        $helper = Mage::helper('radial_core');
    ...
    public function testApiUriCreationNonDefaultStore()
    {
        ...
        $helper = $this->getHelperMock('radial_core/data', ['getConfigModel']);
    ...
    public function testIsValidFtpSettingsWithSftpData($username, $host, $authType, $password, $privKey)
    {
        ...
        $this->assertSame(
            ...
            Mage::helper('radial_core')->isValidFtpSettings()
        );
    }
    ...
    {
        $doc = Mage::helper('radial_core')->getNewDomDocument();
    ...
    {
        $this->assertSame('en-US', Mage::helper('radial_core')->mageToXmlLangFrmt('en_US'));
    }
    ...
    {
        $this->assertSame('1234', Mage::helper('radial_core')->extractNodeVal($nodeList));
    }
    ...
    {
        $this->assertSame('TAN-CLI', Mage::helper('radial_core')->extractNodeAttributeVal($nodeList, $attributeName));
    }
    ...
    public function testExtractQueryNodeValue()
    {
        ...
        $coreHelper    = Mage::helper('radial_core');
    ...
    {
        $this->assertSame($expect, Mage::helper('radial_core')->parseBool($s));
    }
    /**
    ...
    public function testUnderscore($testString, $targetString)
    {
        $this->assertSame(
            $targetString,
            Mage::helper('radial_core')->underscoreWords($testString)
        );
    }
    /**
     ...
     * otherwise return the return value from call the radial_core/data::getCodeFromCouponPool().
     *
     * @param string
     * @param string
     * @param string | null
    ...
    public function testGetQuoteCouponCode($quoteCouponCode, $ruleCouponCode, $result)
    {
        ...
        $helper = $this->getHelperMock('radial_core/data', ['getCodeFromCouponPool']);
