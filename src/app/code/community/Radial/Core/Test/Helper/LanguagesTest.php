...
class Radial_Core_Test_Helper_LanguagesTest extends Radial_Core_Test_Base
{
    /**
    ...
    {
        $actualList   = Mage::helper('radial_core/languages')->getLanguageCodesList();
    ...
    public function testGetAllStores()
    {
        ...
        $stores = Mage::helper('radial_core/languages')->getStores();
        foreach ($stores as $key => $store) {
            $this->assertEquals(
                // Array key is the StoreId
                $key,
                $store->getStoreId()
            );
    ...
    public function testGetStoreByLanguage()
    {
        ...
        $defaultLangStores = Mage::helper('radial_core/languages')->getStores('store3_lang');
    ...
    {
        $this->assertTrue(Mage::helper('radial_core/languages')->validateLanguageCode('en-us'));
    }
    ...
    {
        $this->assertFalse(Mage::helper('radial_core/languages')->validateLanguageCode('3nadbadfaefa04'));
    }
}
