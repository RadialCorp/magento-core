...
class Radial_Core_Test_Helper_Api_ValidatorTest extends Radial_Core_Test_Base
{
    /**
     * Get an radial_core helper to translate the messages. Replaces the translate
     ...
     * @return Mock_Radial_Core_Helper_Data
     */
    protected function _getMockTranslationHelper()
    {
        $helper = $this->getHelperMock('radial_core/data', array('__'));
    ...
    public function testReturnInvalidHostnameResponse()
    {
        ...
        $this->replaceByMock('helper', 'radial_core', $this->_getMockTranslationHelper());
        $this->assertSame(
            array(
                'message' => 'Translated_Radial_Core_Api_Validator_Invalid_Hostname',
                'success' => false
            ),
            Mage::helper('radial_core/api_validator')->returnInvalidHostnameResponse()
        );
    }
    /**
    ...
    public function testReturnUnknownErrorResponse()
    {
        ...
        $this->assertSame(
            array(
                'message' => 'Translated_Radial_Core_Api_Validator_Unknown_Failure',
                'success' => false
            ),
            Mage::helper('radial_core/api_validator')->returnUnknownErrorResponse()
        );
    }
    /**
    ...
    public function provideStatusCodeAndResponseMessage()
    {
        return array(
            array(401, array(
                'message' => 'Translated_Radial_Core_Api_Validator_Invalid_Api_Key',
                'success' => false
            )),
            array(403, array(
                'message' => 'Translated_Radial_Core_Api_Validator_Invalid_Store_Id',
                'success' => false
            )),
            array(408, array(
                'message' => 'Translated_Radial_Core_Api_Validator_Network_Timeout',
                'success' => false
            )),
            array(404, array(
                'message' => 'Translated_Radial_Core_Api_Validator_Unknown_Failure',
    ...
    public function testReturnClientErrorResponse($statusCode, $responseMessage)
    {
        ...
        $this->assertSame(
            $responseMessage,
            Mage::helper('radial_core/api_validator')->returnClientErrorResponse($response)
        );
    }
    /**
    ...
    public function testReturnSuccessResponse()
    {
        ...
        $this->assertSame(
            array(
                'message' => 'Translated_Radial_Core_Api_Validator_Success',
                'success' => true
            ),
            Mage::helper('radial_core/api_validator')->returnSuccessResponse()
        );
    }
}
