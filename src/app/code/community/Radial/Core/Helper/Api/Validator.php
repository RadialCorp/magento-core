 ...
 */
class Radial_Core_Helper_Api_Validator
{
    const INVALID_HOSTNAME = 'Radial_Core_Api_Validator_Invalid_Hostname';
    const INVALID_STORE_ID = 'Radial_Core_Api_Validator_Invalid_Store_Id';
    const INVALID_API_KEY = 'Radial_Core_Api_Validator_Invalid_Api_Key';
    const NETWORK_TIMEOUT = 'Radial_Core_Api_Validator_Network_Timeout';
    const UNKNOWN_FAILURE = 'Radial_Core_Api_Validator_Unknown_Failure';
    const SUCCESS = 'Radial_Core_Api_Validator_Success';
    ...
    {
        return array(
            'message' => Mage::helper('radial_core')->__(self::INVALID_HOSTNAME),
            'success' => false
        );
    }
    /**
    ...
    {
        return array(
            'message' => Mage::helper('radial_core')->__(self::UNKNOWN_FAILURE),
            'success' => false
        );
    }
    /**
    ...
    {
        return array(
            'message' => Mage::helper('radial_core')->__(self::SUCCESS), 'success' => true
        );
    }
}
