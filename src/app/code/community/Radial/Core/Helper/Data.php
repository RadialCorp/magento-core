...
/**
 * Class Radial_Core_Helper_Data
 *
 * A loose collection of semi-static methods that are used by independent
 * modules across Retail Order Management.
 */
class Radial_Core_Helper_Data extends Mage_Core_Helper_Abstract implements Radial_Core_Helper_Interface
{
    ...
    public function getConfigModel($store = null)
    {
        return Mage::getModel('radial_core/config_registry')
            ->setStore($store)
            ->addConfigModel(Mage::getSingleton('radial_core/config'));
    }
