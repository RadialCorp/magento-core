...
class Radial_Core_Helper_Shipping
{
    ...
    public function __construct(array $init = [])
    {
        list(
            ...
            $this->nullCoalesce($init, 'config', Mage::helper('radial_core')->getConfigModel()),
     ...
     * @param string
     * @return string
     * @throws Radial_Core_Exception If an id for the shipping method cannot be found.
     */
    public function getMethodSdkId($shippingMethod)
    {
        ...
        if (!$shippingMethod) {
            ...
            throw Mage::exception('Radial_Core', 'Unable to find a valid shipping method');
        }
