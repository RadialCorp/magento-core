...
(function () {
    ...
    var usernameElementId = 'radial_core_radial_amqp_username';
    var passwordElementId = 'radial_core_radial_amqp_password';
    var hostnameElementId = 'radial_core_radial_amqp_hostname';
